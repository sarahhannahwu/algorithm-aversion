...
# Remake table
coded_table %>% 
  select(first_author_last_name, title, Year, Journal, journal_field, Method, theory_framework, N, task_objectivity, Type_of_human_manipulated, Algorithm_orientations) %>% 
  rename("First Author" = first_author_last_name,
         "Title" = title,
